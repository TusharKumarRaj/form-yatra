        ...
        >
            ...
            <header className="w-full shrink-0" style={{ background: T.nav }}>
                <nav className="w-full px-10 py-3 flex items-center justify-between">
                    ...
                    <p className="text-sm font-semibold" style={{ color: `${T.cream}60` }}>
                        Have an account?{" "}
                        <a href="/signin" style={{ color: T.border }} className="hover:underline">Sign in</a>
                    </p>
                </nav>
            </header>
            ...
            <div className="flex flex-1 flex-col min-h-0">
                ...
                <div className="flex flex-1 min-h-0 overflow-hidden">
                    ...
                    {/* LEFT — Sign up form panel (same structure as home left panel) */}
                    <div
                        className="flex flex-col h-full w-full lg:max-w-[44%] shrink-0"
                        style={{ background: T.panel, borderRight: `3px solid ${T.border}` }}
                    >
                        {/* Top: pattern fill spacer */}
                        ...
                        <div className="shrink-0 flex flex-col gap-7 px-12">
                            ...
                            <div>
                                <h1 className="font-black text-4xl uppercase tracking-tight leading-[1.05]"
                                    style={{ color: T.cream }}>
                                    Start Your<br /><span style={{ color: T.border }}>Yatra</span>
                                </h1>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                ...
                                {isSuccess && <p className="text-sm font-semibold" style={{ color: "#4ade80" }}>Account created!</p>}
                        ...
                        {/* Bottom: balanced spacer */}
                        <div className="flex-1 min-h-0" aria-hidden />
                    </div>

                    {/* RIGHT — Kerala illustration */}
                    <div className="hidden lg:block flex-1 relative overflow-hidden">
                        <Image
                            src={keralaImg}
                            alt="Kerala backwaters illustration"
                            fill
                            className="object-cover object-center"
                            quality={95}
                        />
                        {/* Blend left edge into form panel */}
                        <div className="absolute inset-y-0 left-0 w-40 pointer-events-none z-10"
                            style={{ background: `linear-gradient(to left, transparent, ${T.panel})` }} />
                        ...
                        {/* City chip */}
                        <div
                            className="absolute top-5 right-5 z-20 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-wider"
